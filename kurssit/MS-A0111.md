...
- **MS-A0211** Differential and Integral Calculus 2 — the direct continuation covering multivariable calculus.
- **MS-A0011** Matrix Algebra — the companion linear algebra course, typically taken in the same academic year.
- **PHYS-C0110** Mechanics — uses calculus extensively; taking Calc 1 concurrently or before Mechanics is beneficial.
- **MS-A0311** Vector Calculus — further mathematical tools for physics and engineering students.
